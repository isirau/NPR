function [numberPlateData]= processImage(img)
...
vars={'rgb','g','Kmedian','conc','gi','ge','gdiff','Iprops','B','er','NR','xlow','xhigh','xadd','yadd','final1','numberPlateData'};
...
if ~isempty(r)
    ...
    for n=1:size(Iprops1,1)
        ...
        figure(n+6)
        imshow(I1{1,n});
         outputLetter=letterPrediction(I1{1,n});
        prediction=strcat(prediction,outputLetter);
    end
